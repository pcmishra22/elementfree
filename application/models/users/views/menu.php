        ...
        ?>
                        ...
                        <a href="#"><i class="fa fa-tags"></i><span class="sidebar-text">Docufiler</span><span class="fa arrow"></span></a>
                        <ul class="submenu collapse">
           ...
           <?php
				...
				?> 
				                    <li>
																...
																<input type="hidden" name="datefiller" value="<?php echo $datefilter_1;?>" >
																<a class="sidebar-text"> <input type="submit" class="text_menu_button" value="All categories"> <span class="<?php echo $badge;?>"><?php echo $totalfiles;?></span><?php echo $new;?></a>
																</form>
                            </li> 
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="#"><i class="fa fa-file-text"></i><span class="sidebar-text">Documents</span><span class="fa arrow"></span></a>
                        	<ul class="submenu collapse">
                            <li>
                            ...
                            <li >
                                <a href="<?php echo base_url();?>users/uploadfiles"><i class="fa fa-cloud-upload"></i><span class="sidebar-text">Upload Files</span></a>
                            </li>                            
                        </ul>    
                    </li>
                    <li>
                        <a href="<?php echo base_url();?>index.html" target="_blank"><i class="glyph-icon flaticon-settings21"></i><span class="sidebar-text">Settings</span><span class="fa arrow"></span></a>
                    			<ul class="submenu collapse">
                            <li>
                                <a href="<?php echo base_url();?>users/accountinfo"><i class="glyph-icon flaticon-bust"></i><span class="sidebar-text">My Profile</span></a>
                            </li>
                            <li>
                                <a href="<?php echo base_url();?>users/accountinfo"><i class="fa fa-credit-card"></i><span class="sidebar-text">Account</span></a>
                            </li>
                            <li >
                                <a href="<?php echo base_url();?>users/filespreview"><i class="fa fa-edit"></i><span class="sidebar-text">Edit Categories</span></a>
                            </li>
                            <li >
                ...
                <div id="sidebar-charts">
                    <div class="sidebar-charts-inner">
                        <div class="sidebar-charts-left">
                            ...
                            <div class="sidebar-chart-number"><?php echo $totalfiles;?></div>
                        </div>
