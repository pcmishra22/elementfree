            ...
            <div class="col-sm-6 col-md-4 col-sm-offset-3 col-md-offset-4">
                <div class="login-box clearfix animated flipInY">
                    ...
                    <div class="login-form">
                        ...
                        <!-- END ERROR BOX -->
                        <form action="<?php echo base_url()?>users/loginverify" method="post" name="login" id="login">
                            <input type="text" placeholder="Username" class="input-field form-control user" name="username" id="username" />
                            <input type="password" placeholder="Password" class="input-field form-control password" name="password" id="password" />
