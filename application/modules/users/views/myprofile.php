...
if(!empty($userdetails[0]))
{
	...
	$usertype=$userdetails[0]['usertype'];
        $rfname=$userdetails[0]['rfirstname'];
	$rlname=$userdetails[0]['rlastname'];
                            ...
                            <div class="tabbable tabbable-custom form">
                                <ul class="nav nav-tabs">
                                    ...
                                    <!--<li><a href="#email_settings" data-toggle="tab">Notifications</a></li>
                                     <li><a href="#account_settings" data-toggle="tab">Account</a></li> -->
                                </ul>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <ul class="list-unstyled profile-nav col-md-3">
                                                            <li>
                                                                <img src="<?php echo base_url();?>/images/assets/img/avatars/avatar2_big.png" alt="avatar 4"/>
                                                            </li>
                                                        </ul>
                                                        <div class="col-md-9">
                                                            <div class="row">
                                                                <div class="col-md-12 profile-info">
                                                                    ...
                                                                    <ul class="list-unstyled list-inline">
                                                                        ...
                                                                        <li class="m-r-20"><i class="fa fa-star p-r-5 c-blue"></i>Account Owner</li>
                                                        ...
                                                        <div class="panel">
                                                            ...
                                                            <div class="panel-body">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6"><a href="#"><?php echo $rfname." ".$rlname; ?></a></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="panel">
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6"><a href="#">June 2012</a></div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row profile-classic">
