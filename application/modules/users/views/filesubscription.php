<?php
$flag='';
if( strpos(@$_SERVER['HTTP_REFERER'],'uploadfiles') || strpos(@$_SERVER['HTTP_REFERER'],'intro') || strpos(@$_SERVER['HTTP_REFERER'],'dashboard') )
{
	$flag=true;	
}
else
...
<div class="pricing-area">
	<div class="container">
    	<h2 class="bule-text">You have reached the maximum amount of files on your plan, please select a plan below to continue enjoying ElementFree</h2>
    </div>
        	 ...
        	 <div class="col-lg-12 col-sm-12 col-xs-12 col-md-12 zero-padding whole-blue-pad">
                ...
                <div class="col-lg-4 col-sm-4 col-xs-4 col-md-4 zero-padding padding-one personal-plan">
                	<div class="color-full-box-ratetag">
                        ...
                        <p class="white-backgroud information-quality color-code-light-grey" ><?php echo $subscriptiondetails[0]['discount'];?></p> 
                        <ul class="button-personal-plan personal-plan-pad">
                        	<li><a href="<?php echo base_url()?>users/signup/3"><span><img src="<?php echo base_url();?>images/frontend/gear39.png" class="img-responsive star" </span>Get Business Plan</a></li>
                        </ul>    
                    </div>
